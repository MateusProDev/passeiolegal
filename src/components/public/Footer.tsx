      ...
      <div className="container mx-auto px-4 pt-12 pb-[calc(3rem+env(safe-area-inset-bottom))]">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col items-center gap-4 sm:flex-row sm:items-center sm:gap-2">
              <div className="relative order-3 h-[240px] w-full max-w-[352px] sm:order-1 sm:h-20 sm:w-44">
                <Image
                  src="/cadastur.png"
                  alt="Cadastur"
                  fill
              ...
              <div className="relative order-2 h-[270px] w-full max-w-[352px] sm:order-2 sm:h-20 sm:w-44">
                <Image
                  src="/seguranca.png"
              ...
              <div className="relative order-1 h-[240px] w-full max-w-[352px] sm:order-3 sm:h-20 sm:w-44">
                <Image
                  src="/pagamentos.png"
